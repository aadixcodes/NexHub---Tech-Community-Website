...
const FeedbackForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const SHEET_URL = 'https://script.google.com/macros/s/AKfycbxC3DM_QMx6SzrCui-eSrD4VkLx1H_xTgNcl_6B-0OtQP6Ggi-LTKG7CFaR1nCohkErPQ/exec';
...
-all"
        ...
        <div className="mt-12 bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <a
              href="https://chat.whatsapp.com/KzT0nik5nY577q5XsUqOSR"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 p-3 rounded-lg bg-gradient-to-r from-green-100 to-emerald-100 hover:from-green-200 hover:to-emerald-200 transition-colors"
            >
